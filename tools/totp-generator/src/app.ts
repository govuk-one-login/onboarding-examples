...
const createApp = (): Application => {
  ...
  app.get('/', (req: Request, res: Response) => {
    res.send(`
      ...
      <p>Generate a one time password by making a GET request to: <code>/totp?secret=your-secret-key</code></p>
      <p>Example: <a href="/totp?secret=example-secret>/totp?secret=example-secret</a></p>
